...
// definitions of styles, common skins, etc
var red = "#db3a1c";
var blue = "#4682EA";
var yellow = "#FDBA35";
var orange = "#FF7F00";
...
/**
 * Actual edit page for a given window.
 */
...
/**
 * The main window for an edit page, as far as the nav bar is concerned is
 * the window you can edit on it.
 */
...
/**
 * When the edit page is navigated to, be sure to put the window preview into its
 * root container.
 */
...
/**
 * Given a tab string that is either "control", "images", or "tint",
 * select that given tab by making it larger/highlighted in the kinoma container.
 */
...
EditPage.prototype.getContainer = function () {
    ...
    page.controls.images = new AddImageButton(page);
    page.controls.control = new controlButton();
    ...
    var rootContainter = new Container({
