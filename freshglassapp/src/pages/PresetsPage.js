...
var PresetsPage = function (windows, switchPages) {
    ...
    var calImg ={ url: calURL, height: 250, width: 200, x: 30, y: 10};
...
PresetsPage.prototype.getContainer = function () {
    ...
    page.displayLine.add(valPreset, calPreset);
...
PresetsPage.prototype.addToPresetsPage = function(window) {
    //add a fake window? 
    trace("PresetsPage addToPresetsPage\n");
    ...
    var newPresetPreview = new PresetPreview({
        ...
        url:window.images[0].url,
    });
    trace("presets len=3? " +  this.presets.length);
    this.displayList.add(newPreset);
}
